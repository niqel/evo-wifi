...
This folder contains the architecture material for evo-wifi.
...
- [General architecture](./diagrams/evo-wifi-general-architecture.png)
- [Project architecture](./diagrams/evo-wifi-project-architecture.png)

The SVG and D2 sources are stored in the same `diagrams/` folder.
