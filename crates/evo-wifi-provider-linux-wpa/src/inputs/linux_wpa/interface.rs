use evo_wifi_core::borrowed::WifiInterfaceBorrowed;
use evo_wifi_core::contracts::WifiInterfaceContract;
use std::env;
use std::fs;
use std::process::Command;

#[derive(Clone, Copy, Debug, Default)]
pub struct LinuxWpaWifiInterfaceProvider;

impl WifiInterfaceContract for LinuxWpaWifiInterfaceProvider {
