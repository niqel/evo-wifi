use evo_wifi_core::borrowed::{
    WifiInterfaceBorrowed, WifiSavedNetworkBorrowed, WifiSavedSecretBorrowed,
};
use evo_wifi_core::contracts::WifiSavedSecretContract;
use std::fs;
use std::process::Command;

#[derive(Clone, Copy, Debug, Default)]
pub struct LinuxWpaWifiSavedSecretProvider;

impl WifiSavedSecretContract for LinuxWpaWifiSavedSecretProvider {
    fn provide<R>(
        &self,
