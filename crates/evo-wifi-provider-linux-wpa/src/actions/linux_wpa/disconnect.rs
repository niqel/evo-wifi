...
use evo_wifi_core::contracts::WifiDisconnectContract;
use std::process::{Command, Output};
use std::thread;
use std::time::Duration;

#[derive(Clone, Copy, Debug, Default)]
pub struct LinuxWpaWifiDisconnectProvider;

impl WifiDisconnectContract for LinuxWpaWifiDisconnectProvider {
    fn provide<R>(
        &self,
